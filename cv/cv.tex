...
Mathematical logician and software engineer interested in AI-assisted mathematics, formal verification, and machine learning. Five papers in descriptive set theory, including the \emph{Journal of the European Mathematical Society} and \emph{Advances in Mathematics}; Lean~4 formalizations of mathematics; and just over a year as a software engineer at Meta working on machine learning for ad targeting.

\smallskip
\textbf{Tools:} Lean~4 with Mathlib, Python, \LaTeX{}, git, Pytorch; familiar with numpy, matplotlib; earlier industry work in Hack, JavaScript, Haskell,
and C.
...
\begin{itemize}
  ...
  \item Approximately 5{,}700 lines of Lean, co-authored with Claude Code.
...
\begin{itemize}
  ...
  \begin{itemize}
    \item Lean 4 formalization and AI assisted mathematics
    \item Completed revisions on several papers
